...
## 3. Powers of an Element in a Multiplicative G
...
By definition, a field $(\mathbb{F}, + , \cdot)$ consists of two Abelian (binary operators are commutative) groups:

1. **Additive group**: $(\mathbb{F}, +)$, which is Abelian and finite in a finite field.
2. **Multiplicative group**: $(\mathbb{F^*}, \cdot)$  (where $\mathbb{F}^* = \mathbb{F}\setminus\{0\}$), which is also Abelian and finite in a finite field.
