...
<img title="" src="https://static.wixstatic.com/media/935a00_19c62a78929f4cb28ee0e42a14e8ff85~mv2.png/v1/fill/w_861,h_574,al_c,lg_1,q_90,enc_auto/935a00_19c62a78929f4cb28ee0e42a14e8ff85~mv2.png" alt="Meme matemático sobre extensiones de campo" width="285">
...
revert("Emparejamiento incorrecto");
}
}
```
...
contrato PairingsTest es Test {
Pairings público pairings;

función setUp() público {
pairings = new Pairings();
}

función testPairings() público view {
...
// opcional, la precompilación también verifica esto y revierte (sin error) si es falso, esto ayuda a reducir los posibles errores
...
bytes puntos de memoria = abi.encode(
aG1_x,
aG1_y,
bG2_x2,
bG2_x1,
...
bool x = pairings.run(puntos);
console2.log("resultado:", x);
}
```
